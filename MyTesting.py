...
dataset='SealsThermal'
def main():
    parser = argparse.ArgumentParser()
    parser.add_argument('--testsize', type=int, default=416, help='testing size (debe coincidir con train)')
    parser.add_argument('--pth_path', type=str, default=f'C:/Respaldo/Henry/Proyecto Camuflaje/Codigo/AVNet-main/model_pth/AVNet_{dataset}/Net_epoch_best.pth')#
